...
PATH_TRAIN_JSON = "./train/_annotations.coco.json"

f = open(PATH_TRAIN_JSON)
data = json.load(f)
...
with open("categories.txt", "w") as text_file:
...
result.to_csv('train_images_info.csv', index=False)
