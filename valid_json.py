...
PATH_VALID_JSON = "./valid/_annotations.coco.json"

f = open(PATH_VALID_JSON)
data = json.load(f)
...
with open("valid_categories.txt", "w") as text_file:
...
result.to_csv('valid_images_info.csv', index=False)